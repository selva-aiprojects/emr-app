...
async function loginAsAdmin(page) {
  ...
  await page.waitForSelector('select[name="tenantId"] option[value="EHS"]', {
    state: 'attached',
    timeout: 30000,
  });

  await page.locator('select[name="tenantId"]').selectOption({ label: 'Enterprise Hospital Systems' });
