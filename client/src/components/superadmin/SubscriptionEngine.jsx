...
const FALLBACK_PLANS = [
  ...
  { id: 'enterprise',   name: 'Enterprise',   cost: '1299', period: 'per mo',  color: 'emerald', moduleKeys: ['dashboard','patients','appointments','emr','reports','admin','users','support','communication','documents','inventory','pharmacy','ambulance','lab','inpatient','billing','accounts','accounts_receivable','accounts_payable','insurance','service_catalog','hospital_settings','departments','bed_management','employees','hr','payroll','donor','ai_analysis','document_vault'], features: ['Dedicated Server','AI Assistance Matrix','99.9% SLM Guarantee'] },
];
