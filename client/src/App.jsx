...
export default function App() {
  ...
  const [emrWorkflow, setEmrWorkflow] = useState('dashboard');
            ...
            <>
              ...
              try {
                ...
                const encounterRes = await api.addEncounter({
                  ...
                  plan: data.plan,
                  notes: data.notes,
                  bp: (data.vitals?.bp?.systolic && data.vitals?.bp?.diastolic) ? `${data.vitals.bp.systolic}/${data.vitals.bp.diastolic}` : data.bp,
