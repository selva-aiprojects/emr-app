...
class PrismaService {
  ...
  getTenantScopedPrisma(tenantId) {
    return {
      // Patient operations
      patient: {
        findMany: (args) => this.prisma.patient.findMany({ ...args, where: { ...args.where, tenantId } }),
        findUnique: (args) => this.prisma.patient.findUnique(args),
        create: (args) => this.prisma.patient.create({ ...args, data: { ...args.data, tenantId } }),
        update: (args) => this.prisma.patient.update(args),
        delete: (args) => this.prisma.patient.delete(args),
        count: (args) => this.prisma.patient.count({ ...args, where: { ...args.where, tenantId } }),
      },

      // User operations
      user: {
        findMany: (args) => this.prisma.user.findMany({ ...args, where: { ...args.where, tenantId } }),
        findUnique: (args) => this.prisma.user.findUnique(args),
        create: (args) => this.prisma.user.create({ ...args, data: { ...args.data, tenantId } }),
      ...
      appointment: {
        findMany: (args) => this.prisma.appointment.findMany({ ...args, where: { ...args.where, tenantId } }),
        findUnique: (args) => this.prisma.appointment.findUnique(args),
        create: (args) => this.prisma.appointment.create({ ...args, data: { ...args.data, tenantId } }),
      ...
      encounter: {
        findMany: (args) => this.prisma.encounter.findMany({ ...args, where: { ...args.where, tenantId } }),
        findUnique: (args) => this.prisma.encounter.findUnique(args),
        create: (args) => this.prisma.encounter.create({ ...args, data: { ...args.data, tenantId } }),
      ...
      // Invoice operations
      invoice: {
        findMany: (args) => this.prisma.invoice.findMany({ ...args, where: { ...args.where, tenantId } }),
        findUnique: (args) => this.prisma.invoice.findUnique(args),
        create: (args) => this.prisma.invoice.create({ ...args, data: { ...args.data, tenantId } }),
      ...
      inventory: {
        findMany: (args) => this.prisma.inventory.findMany({ ...args, where: { ...args.where, tenantId } }),
        findUnique: (args) => this.prisma.inventory.findUnique(args),
        create: (args) => this.prisma.inventory.create({ ...args, data: { ...args.data, tenantId } }),
      ...
      // Employee operations
      employee: {
        findMany: (args) => this.prisma.employee.findMany({ ...args, where: { ...args.where, tenantId } }),
        findUnique: (args) => this.prisma.employee.findUnique(args),
        create: (args) => this.prisma.employee.create({ ...args, data: { ...args.data, tenantId } }),
      ...
      department: {
        findMany: (args) => this.prisma.department.findMany({ ...args, where: { ...args.where, tenantId } }),
        findUnique: (args) => this.prisma.department.findUnique(args),
        create: (args) => this.prisma.department.create({ ...args, data: { ...args.data, tenantId } }),
