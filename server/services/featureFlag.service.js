...
export const MODULE_FLAG_MAPPING = {
  ...
  ambulance: FEATURE_FLAGS.PHARMACY_LAB_ACCESS, // Fleet logistics bundled with clinical services
...
// Default feature flags by subscription tier (Hardened as per FEATURES.md v2.0)
...
// Official Platform Pricing (Indicative for billing modules)
