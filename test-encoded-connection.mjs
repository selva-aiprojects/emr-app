// Test URL-Encoded Supabase Connection String
import pg from 'pg';

const DATABASE_URL = "postgresql://postgres:hms-app%402020@db.vfmnjnwcorlqwxqdklfi.supabase.co:5432/postgres";
...
async function testEncodedConnection() {
  ...
  try {
    console.log('🔍 Testing URL-encoded connection string...');
...
testEncodedConnection().catch(console.error);
