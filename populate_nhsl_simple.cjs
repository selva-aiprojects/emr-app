...
(async () => {
  try {
    console.log('=== Populating NHSL with 3 Months Core Data ===');
    ...
    // 2. Add Staff (Doctors, Nurses, Admin, Support)
    console.log('\n=== Adding NHSL Staff ===');
    const staffIds = [];
    ...
    const doctorSpecializations = [
      ...
      'General Surgery', 'Anesthesiology', 'Radiology', 'Pathology', 'Internal Medicine',
      'Critical Care', 'Pulmonology', 'Gastroenterology', 'Nephrology', 'Oncology',
      'Endocrinology', 'Dermatology', 'Psychiatry', 'Ophthalmology', 'ENT',
      'Interventional Cardiology', 'Electrophysiology', 'Joint Replacement', 'Spine Surgery', 'Neonatology',
      'Obstetrics', 'Laparoscopic Surgery', 'Cardiothoracic Surgery', 'Interventional Radiology', 'Clinical Pathology'
    ];
    ...
    for (let i = 0; i < 30; i++) {
      ...
      const staffData = {
        ...
        designation: ['Senior Consultant', 'Consultant', 'Specialist', 'Chief Physician', 'Attending Physician', 'Associate Consultant'][Math.floor(Math.random() * 6)],
    ...
    for (let i = 0; i < 45; i++) {
      ...
      const staffData = {
        ...
        department: departments[departmentIndex].name,
        designation: ['Senior Nurse', 'Nurse Manager', 'Head Nurse', 'Charge Nurse', 'Registered Nurse', 'Nurse Practitioner', 'Critical Care Nurse', 'ICU Nurse'][Math.floor(Math.random() * 8)],
    ...
    for (let i = 0; i < 20; i++) {
      ...
      const staffData = {
        ...
        department: departments[departmentIndex].name,
        designation: ['Hospital Administrator', 'Medical Records Officer', 'Billing Manager', 'Receptionist', 'Front Office Executive', 'Patient Coordinator', 'Ward Clerk', 'Medical Coder'][Math.floor(Math.random() * 8)],
    ...
    for (let i = 0; i < 15; i++) {
      ...
      const staffData = {
        ...
        department: departments[departmentIndex].name,
        designation: ['Lab Technician', 'Radiology Technician', 'Pharmacist', 'Medical Assistant', 'Security Officer', 'Housekeeping Supervisor', 'Dietitian', 'Social Worker'][Math.floor(Math.random() * 8)],
    ...
    // 3. Add Patients (120 patients over 3 months)
    ...
    // 4. Add Appointments (360 appointments over 3 months)
    ...
    for (let i = 0; i < 360; i++) {
      ...
      const appointmentData = {
        ...
        provider_id: staffIds[Math.floor(Math.random() * 30)], // Only doctors as providers
    ...
    // 5. Add Invoices (240 invoices over 3 months)
    ...
    // 7. Add Encounters (160 encounters over 3 months)
    ...
    for (let i = 0; i < 160; i++) {
      ...
      const randomDoctor = staffIds[Math.floor(Math.random() * 30)]; // Only doctors
