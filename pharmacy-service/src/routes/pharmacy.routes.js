...
// GET /api/pharmacy/v1/drugs/:id/substitutes - Get generic substitutes
router.get('/drugs/:id/substitutes', requireRole('Doctor', 'Nurse', 'Lab', 'Pharmacy'), getGenericSubstitutes);
