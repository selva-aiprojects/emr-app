...
async function populateDemoTenantFinal() {
  ...
  for (let i = 0; i < 150; i++) {
    ...
    try {
      ...
      `, [
        ...
        getRandomItem(['Hypertension', 'Diabetes Type 2', 'Astrhma', 'Arthritis', 'Migraine', 'Depression']),
...
populateDemoTenantFinal().then(result => {
