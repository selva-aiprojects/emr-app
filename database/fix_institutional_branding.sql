...
-- emr.management_tenants (sync target)
ALTER TABLE emr.management_tenants 
ADD COLUMN IF NOT EXISTS theme jsonb DEFAULT '{}',
ADD COLUMN IF NOT EXISTS features jsonb DEFAULT '{}',
ADD COLUMN IF NOT EXISTS billing_config jsonb DEFAULT '{}';
...
-- UPDATE emr.tenants SET theme = '{"primary": "#0f5a6e"}' WHERE id::text = 'your-tenant-uuid' RETURNING id, theme;
