...
CREATE INDEX IF NOT EXISTS idx_emr_admin_settings_active ON admin_settings(is_active);

-- Tenant settings indexes
CREATE INDEX IF NOT EXISTS idx_emr_tenant_settings_tenant_id ON tenant_settings(tenant_id);
CREATE INDEX IF NOT EXISTS idx_emr_tenant_settings_category ON tenant_settings(category);

-- User settings indexes
CREATE INDEX IF NOT EXISTS idx_emr_user_settings_user_id ON user_settings(user_id);
CREATE INDEX IF NOT EXISTS idx_emr_user_settings_category ON user_settings(category);

-- Graphics settings indexes
CREATE INDEX IF NOT EXISTS idx_emr_graphics_settings_tenant_id ON graphics_settings(tenant_id);
CREATE INDEX IF NOT EXISTS idx_emr_graphics_settings_type ON graphics_settings(setting_type);
...
CREATE INDEX IF NOT EXISTS idx_emr_notification_settings_type ON notification_settings(notification_type);
...
CREATE INDEX IF NOT EXISTS idx_emr_security_settings_category ON security_settings(category);
...
CREATE INDEX IF NOT EXISTS idx_emr_audit_logs_action ON audit_logs(action);
...
CREATE INDEX IF NOT EXISTS idx_emr_file_uploads_category ON file_uploads(category);
