...
-- ============================================================
-- Version: 2.5.0 (MAGNUM GROUP OF HOSPITALS LTD - Enterprise RLS + Seed Data)
-- Architecture: Institutional Isolation
-- Description: Canonical DDL containing 60+ tables for full EMR operations.
-- Updated: Added Physician Scheduling & Search Performance Indexes
-- ============================================================
...
-- Performance Optimization: Trigram Indexes for Fast Patient Search
...
-- Trigger for doctor_schedules updated_at
