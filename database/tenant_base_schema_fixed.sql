-- ============================================================
-- CORRECTED TENANT BASE SCHEMA - MedFlow EMR v2.0
-- ============================================================
-- This script creates tables in the TENANT'S schema directly
-- NOT in emr.<schema> but in <schema> directly
--
-- ARCHITECTURE:
...
BEGIN
    ...
    RAISE NOTICE 'Tables created: 50+ tables across all EMR modules';
