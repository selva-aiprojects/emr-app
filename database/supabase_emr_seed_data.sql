-- =====================================================
-- EMR Application - Sample Data for Custom Schema
-- =====================================================
-- Uses 'emr' schema tables
-- =====================================================
...
BEGIN
    RAISE NOTICE '====================================================';
    RAISE NOTICE 'EMR Sample Data Seeding Complete!';
    RAISE NOTICE '====================================================';
    ...
    RAISE NOTICE '====================================================';
    RAISE NOTICE 'EMR database with custom schema is ready!';
    RAISE NOTICE '====================================================';
END $$;
