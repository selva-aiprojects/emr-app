...
-- DEPARTMENTS
INSERT INTO emr.departments (tenant_id, name, code, status)
...
WHERE NOT EXISTS (SELECT 1 FROM emr.departments WHERE tenant_id = 'f998a8f5-95b9-4fd7-a583-63cf574d65ed' AND code = d.c);
...
WHERE NOT EXISTS (SELECT 1 FROM emr.wards WHERE tenant_id = 'f998a8f5-95b9-4fd7-a583-63cf574d65ed' AND name = w.n);
...
FROM emr.wards w, generate_series(1, 10) s(i)
WHERE w.tenant_id = 'f998a8f5-95b9-4fd7-a583-63cf574d65ed'
AND NOT EXISTS (
  SELECT 1 FROM emr.beds b 
...
-- SERVICES
INSERT INTO emr.services (tenant_id, name, code, category, base_rate, tax_percent, status)
...
WHERE NOT EXISTS (SELECT 1 FROM emr.services WHERE tenant_id = 'f998a8f5-95b9-4fd7-a583-63cf574d65ed' AND code = s.c);

-- EMPLOYEES
INSERT INTO emr.employees (tenant_id, name, code, designation, department)
SELECT 'f998a8f5-95b9-4fd7-a583-63cf574d65ed', 'Dr. Michael Chen', 'EMP-001', 'CMO', 'Cardiology'
WHERE NOT EXISTS (SELECT 1 FROM emr.employees WHERE tenant_id = 'f998a8f5-95b9-4fd7-a583-63cf574d65ed' AND code = 'EMP-001');

INSERT INTO emr.employees (tenant_id, name, code, designation, department)
SELECT 'f998a8f5-95b9-4fd7-a583-63cf574d65ed', 'Emily Rodriguez', 'EMP-002', 'Head Nurse', 'Emergency'
WHERE NOT EXISTS (SELECT 1 FROM emr.employees WHERE tenant_id = 'f998a8f5-95b9-4fd7-a583-63cf574d65ed' AND code = 'EMP-002');
...
AND id NOT IN (SELECT patient_id FROM emr.appointments WHERE tenant_id = 'f998a8f5-95b9-4fd7-a583-63cf574d65ed')
LIMIT 5;
